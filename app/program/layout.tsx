...
export const metadata: Metadata = {
  title: "The Vetted Accelerator | Elite 10-Week Accelerator for Veteran Entrepreneurs",
  description: "The Vetted accelerator: 10-week elite startup program for combat veterans. IL & USA Veterans Join global network of veteran entrepreneurs building world-class companies.",
  ...
  openGraph: {
    title: "The Vetted Accelerator | Elite 10-Week Accelerator",
